...
e = conn.execute("insert into product values (1, 'Люстра', 4,'l.jpg','ab0001-4', 2,2,1, 25, 1,2, 10, 1)")
e = conn.execute("insert into product values (2, 'Коврик в ванную', 5,'k.jpg','ac0002-5', 1,3,2, 125, 1,2, 10, 1)")
e = conn.execute("insert into product values (3, 'Плитка белая', 1,'p.jpg','rt0003-1',2,1,3, 525, 2,3, 10, 20)")
print(e)
